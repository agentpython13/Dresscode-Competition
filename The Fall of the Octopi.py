...
font = pygame.font.Font("PublicPixel-z84yD.ttf", 13)
bigger_font = pygame.font.Font("PublicPixel-z84yD.ttf", 23)
biggest_font = pygame.font.Font("PublicPixel-z84yD.ttf", 60)
huge_font = pygame.font.Font("PublicPixel-z84yD.ttf", 95)
white = (255,255,255)
black = (0,0,0)
red = (255,0,0)
green = (0,255,0)
...
bullet_sfx = pygame.mixer.Sound("/Users/Bennet/Desktop/Dresscode/mixkit-sci-fi-positive-notification-266.wav")
hit_sfx = pygame.mixer.Sound("mixkit-arcade-mechanical-bling-210.wav")


player_rect = pygame.Rect(180, 550, player_dimension, player_dimension)

player = pygame.image.load("spaceship_red.png")
...
def draw_game(player_health, score, enemy_speed):
    ...
    for enemy_rect in enemies:   
        enemy = pygame.image.load("vector-pixel-art-monster-head-isolated-cartoon-2C34N4G.jpg")
